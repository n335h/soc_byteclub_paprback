...
function ListBook() {
  const listYourBookRef = useRef(null);

  const handleListBookClick = () => {
    listYourBookRef.current.scrollIntoView({ behavior: 'smooth' });
  };
            ...
            <div id="user-details">
              ...
              <div id="user-text">
                ...
                <p className="inner-text">
                  <span className="bolded">Name:</span> Zendaya
                  Coleman
                </p>
                <p className="inner-text">
                ...
                <p className="inner-text">
                  <span className="bolded">Address:</span> 27 Fake
                  Street, Faketon, SE1 4NF
                </p>
                <p className="inner-text">
